 ...
 *
 * The module player's old top bar: an Exit control plus a whole-module
 * `SegmentedProgressBar`. Round 33 rebuilt the player around the outline rail
 * (`ModulePlayerNav`) and an 84px footer, which took over both jobs — the top
 * progress bar was removed outright and Exit became "Go Back Home" in the
 * footer. Nothing imports this file.
 *
 * Kept as the reference for the progress-bar treatment, which is not rendered
 * anywhere else. Deleting it is a safe change.
 */
