...
import { EditSessionPlanModal } from '@/components/shared/EditSessionPlanModal'
import { PlanSessionsModal } from '@/components/shared/PlanSessionsModal'
import { SessionPlanEmptyBanner } from '@/components/shared/SessionPlanEmptyBanner'
/* Handover package: these four were exported by the Research Dashboard's own
   `ConsumerDetailPage.tsx`/`SpacesCoachProfilePage.tsx`. Those pages are not
   part of this coach-portal package, so the components were extracted into
   `components/shared/` unchanged — including their `viewerRole` prop, which
   encodes a real permissions distinction rather than a dead branch. */
import {
  SleepDiaryFeed,
  FitbitAveragesTable,
  FitbitSyncMonitor,
} from '@/components/shared/SleepHealthData'
import { ProfileDetailsSections } from '@/components/shared/ProfileDetailsSections'
import {
  dyadsForCoach,
