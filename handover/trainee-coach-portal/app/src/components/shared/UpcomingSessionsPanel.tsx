/**
 * ⚠️ COMPONENT UNUSED — only its TYPE is imported.
 *
 * `DeliveryHomePage` imports `UpcomingSessionRow` from here for typing; the
 * `UpcomingSessionsPanel` component itself has no caller in this package. The
 * day-grouped meetings table that replaced it is
 * `components/shared/MeetingsSection.tsx`.
 *
 * If you delete this file, move the `UpcomingSessionRow` type first — it is
 * live.
 */
