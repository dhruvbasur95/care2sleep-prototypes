      ...
      >
        ...
        <div className="flex flex-col gap-2">
          ...
          <textarea
            ...
            className="w-full rounded-sm border border-parchment bg-parchment px-3 py-2.5 text-body text-ink outline-none transition-colors focus-visible:border-consumer-primary focus-visible:ring-2 focus-visible:ring-consumer-primary"
          />
        </div>
      </ConfirmDialog>
      ...
      >
        {message.trim() && (
          <div className="flex flex-col gap-2">
            ...
            <p className="rounded-sm border border-parchment bg-parchment px-3 py-2.5 text-body whitespace-pre-wrap text-ink">
              {message.trim()}
            </p>
          </div>
        )}
...
export function ConsumerAccountPage() {
  ...
  return (
    <ConsumerShell
      ...
      // slot, which paints `bg-parchment` — the app's COOL grey — across the top of
