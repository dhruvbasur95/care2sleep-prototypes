 ...
 */
const FIELD =
  'h-12 w-full rounded-sm border border-parchment bg-parchment px-3 text-body text-ink outline-none transition-colors focus-visible:border-consumer-primary focus-visible:ring-2 focus-visible:ring-consumer-primary'
 ...
 */
const VALUE_FIELD =
  'flex min-h-12 items-center rounded-sm border border-parchment bg-parchment px-3 py-2.5 text-body break-words text-ink'
