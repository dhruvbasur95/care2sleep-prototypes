...
const STEPS = [0.875, 1, 1.125, 1.25, 1.375, 1.5] as const

/** Index into `STEPS`. 1 is 100%, so there is one step down and four up: the
 *  menu exists to make text bigger, and a symmetric ladder would spend half its
 *  range on a direction almost nobody wants. */
