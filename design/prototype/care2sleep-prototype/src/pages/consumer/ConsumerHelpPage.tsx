...
/** The research team's contact details. Placeholder values from the frame — the
 *  phone number is a UK Ofcom drama-range number on an Australian study, so it
 *  is a stand-in, not a number to dial. */
const RESEARCH_CONTACT = {
  phone: '+44 20 7946 0192',
  email: 'rosemary.vance@monash.edu',
}
