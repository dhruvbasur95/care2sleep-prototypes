 ...
 * project's scars: trap Tab, close on Escape, focus the incoming heading from a
 * **callback ref** rather than an effect, and restore focus to the opener only
 * when focus is still inside the closing panel.
 *
