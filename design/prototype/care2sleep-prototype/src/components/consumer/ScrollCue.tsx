    ...
    <AnimatePresence>
      {hasMore && (
        <motion.button
          ...
          className="fixed right-6 bottom-6 z-20 flex h-14 items-center gap-2 rounded-3xl border border-parchment bg-white px-6 text-body-md text-consumer-primary shadow-float outline-none transition-colors hover:bg-pearl focus-visible:ring-2 focus-visible:ring-consumer-primary focus-visible:ring-offset-2"
