 ...
 *
 * ⚠️ This is NOT `/illustrations/home/wave.svg`. That asset is the same
 * designer's squiggle and even carries the same `Vector 1 - Wave` layer name,
 * but it is stroked `#A070FF` (`purple-400`) for the coach portal's `WaveDivider`
 * against a white card. These are `#3A00AD` — this portal's own
 * `consumer-primary` — on a warm canvas. Reusing the coach asset here would have
 * been a silent colour change, which is why the glyph matching was not enough.
 */
